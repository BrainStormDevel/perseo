<?php
	...
	*/############################################	
	...
	try {
		...
		session_start();
		if ((! @include_once( __DIR__.DIRECTORY_SEPARATOR.'config'.DIRECTORY_SEPARATOR.'routes.php' )) || (!file_exists( __DIR__.DIRECTORY_SEPARATOR.'config'.DIRECTORY_SEPARATOR.'routes.php' ))) { throw new \Exception ( __DIR__.DIRECTORY_SEPARATOR.'config'.DIRECTORY_SEPARATOR.'routes.php does not exist. Download default one from repository.'); }
	}
	catch(Exception $e) {
