...
class Install
{
    ...
    public static function main($container)
    {
        ...
        try {
            ...
            $result = self::createdb($container->Sanitizer->POST('admin', 'user'),
                $container->Sanitizer->POST('email', 'email'), $container->Sanitizer->POST('password', 'pass'),
                $container->Sanitizer->POST('salt', 'alpha'));
            session_unset();
            session_destroy();
        } catch (Exception $e) {
            $result = array(
